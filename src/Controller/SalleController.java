...
public class SalleController implements Initializable {
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		trier.getItems().addAll("Tout", "Pension Terminée", "Pension Incomplète");
	...
	public void Triage() {
		...
		ClasseDAO classeDAO = new ClasseDAO();
		if (trier.getValue().equals("Pension Terminée"))
			listClasses = classeDAO.findAll_1(annee_Scolaire);
		else if (trier.getValue().equals("Pension Incomplète"))

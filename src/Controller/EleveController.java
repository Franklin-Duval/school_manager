...
public class EleveController implements Initializable{
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		trier.getItems().addAll("Tout", "Inscription Terminée", "Inscription Incomplète");
		this.RemplirTable();
	...
	public void Triage() {
		...
		if (trier.getValue().equals("Inscription Terminée"))
			listEleves = eleveDAO.findAll1(annee_Scolaire);
		else if (trier.getValue().equals("Inscription Incomplète"))
